            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <form method="POST" action="<?php echo base_url() ?>Sale/savedSale" >
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            <label>Product</label>
                            <select name="productID" id="productID" onchange="getProductData()" class="form-control chosen" required >
                                <option value="">Select One</option>
    ...
    $('#customerID').onchange(function() { 
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var jsondata = JSON.parse(data);
                var total_amount = jsondata['total_amount'];
                var total_paid = jsondata['total_paid'];
                var total_due = jsondata['total_due'];
                if(total_amount == null) {
                    var span = document.getElementById("total_amount");
                    span.textContent = '0';
               ...
               var payment_percentage = (total_paid * 100) / total_amount;
